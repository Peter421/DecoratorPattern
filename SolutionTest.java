...
class SolutionTest {
	...
	@Test
	void TsatTest1() {
		  Solution tSatTest = new Solution();
	...
	@Test
	void measuredTempTest1() {
		 Solution tMeasTest = new Solution();
	...
	@Test
	void tHeatTest1() {
		 Solution tHeatTest = new Solution();
	...
	@Test
	void tActualTest1() {
		 Solution tActualTest = new Solution();
