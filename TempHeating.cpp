...
int main() {
	...
	double tActual = getTactual(temperature, time);// temperature and time passed as parameter to get actual temperature

	cout << "Based on the time since start up:" << time << "(s) and measured temperature: " << temperature
		<< "(deg cels)The actual temperature is " << tActual << "(deg cels)" << endl;// print actual temperature
